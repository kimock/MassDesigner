...
def make_args():
    ...
    # Model related
    parser.add_argument("--latent_dim", type=int, default=128, help="dimensionality of the latent space") # 128
    parser.add_argument("--noise_dim", type=int, default=32, help="dimensionality of the noise space") # 32
    parser.add_argument("--program_layer", type=int, default=4, help="numbers of message passing in program graph") # 4
    parser.add_argument("--voxel_layer", type=int, default=12, help="numbers of message passing in voxel graph") # 12
    ...
    parser.add_argument("--lp_weight", type=float, default=10, help="link prediction coefficient in G loss")
    parser.add_argument("--tr_weight", type=float, default=1, help="program target ratio coefficient in G loss")
    parser.add_argument("--far_weight", type=float, default=1.2, help="far coefficient in G loss")
    ...
    # Optimizer parameter
    parser.add_argument("--g_lr", type=float, default=0.000000001, help="adam: learning rate")
    parser.add_argument("--d_lr", type=float, default=0.000000001, help="adam: learning rate")
